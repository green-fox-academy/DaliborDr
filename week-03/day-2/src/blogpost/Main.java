...
public class Main {
    public static void main(String[] args) {
        ...
        BlogPost blogPost2 = new BlogPost("Tim Urban","Wait but why","A popular long-form, stick-figure-illustrated " +
                "blog about almost everything.","2010.10.10.");
        BlogPost blogPost3 = new BlogPost("Daniel Hanley","ne Engineer Is Trying to Get IBM to Reckon With Trump",
